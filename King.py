...
class King(Piece):
        ...
        if (currentRow >= 0 and currentRow < 8 and currentCol >= 0 and currentCol < 8):
            if (checkerTown[currentRow][currentCol] != None):
                if (checkerTown[currentRow][currentCol].team != self.team):
                    ...
                    scoutRow, scoutCol = checkerTown[currentRow][currentCol].Kingsman(
                        checkerTown, currentRow + dir1, currentCol + dir2, dir1, dir2)
                    return scoutRow, scoutCol, currentRow, currentCol
            elif (nextLoc):
                return1, return2, return3, return4 = self.iSpy(
                    checkerTown, currentRow + dir1, currentCol + dir2, dir1, dir2)
    ...
    def pleaseGodSaveTheKing(self, enemyRow, enemyCol):
        dir1, dir2 = self.determineDirectionFromEnemyTowardsKing(
            enemyRow, enemyCol)
        saveTheKing = []
